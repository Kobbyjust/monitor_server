...
def discovery():
    ...
    # subnets_to_monitor = ["10.106.111.35/24", "192.168.67.0/24"]
    # ans, unans = scapy.arping("10.106.111.35/24")
    ans, unans = scapy.arping("192.168.52.0/24")
    ans.summary()

    #host2, unans2 = scapy.arping("192.168.0.0/24")
    host2, unans2 = scapy.arping("154.160.27.0/24")
    host2.summary()
